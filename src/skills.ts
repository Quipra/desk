...
PENS WITH CHARACTER. brush + taper for gesture lines; pencil + texture grain for a dry sketch; brush + texture chalk + low opacity for washes; highlighter for a translucent band of light. Design a pen once with make kind brush and reuse it as pen { brush: name }.
